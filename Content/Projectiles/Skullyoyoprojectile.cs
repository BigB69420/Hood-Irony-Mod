...
namespace HoodIrony.Content.Projectiles
{
    public class Skullyoyoprojectile : ModProjectile
    {
        ...
        public override void PostAI()
        {
            ...
            {
                Dust.NewDust(Projectile.position, Projectile.width, Projectile.height, DustID.CrimsonSpray);// Makes the projectile emit dust.
            }
            if (Main.rand.NextBool(1))
            {
                Lighting.AddLight(Projectile.position, 1f, 0.33f, 0.5f);
            }
        }
