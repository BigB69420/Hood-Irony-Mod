...
using HoodIrony.Content.Projectiles;
using HoodIrony.Items.Weapons;

namespace HoodIrony.Items.Weapons
{
    public class Skullyoyo : ModItem
    {
        ...
        {
            Item.width = 40; // The width of the item's hitbox.
            Item.height = 40; // The height of the item's hitbox.
            ...
            Item.damage = 365; // The amount of damage the item does to an enemy or player.
            ...
            Item.knockBack = 10f; // The amount of knockback the item inflicts.
            ...
            Item.rare = ItemRarityID.Purple; // The item's rarity. This changes the color of the item's name.
            Item.value = Item.buyPrice(gold: 120); // The amount of money that the item is can be bought for.

            Item.shoot = ModContent.ProjectileType<Skullyoyoprojectile>(); // Which projectile this item will shoot. We set this to our corresponding projectile.
            Item.shootSpeed = 32f; // The velocity of the shot projectile.	
        }
